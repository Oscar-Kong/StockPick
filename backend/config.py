...
# --- Active-position monitoring (read-only; independent opt-in scheduler) ---
ACTIVE_POSITION_MONITOR_ENABLED = _env_bool("ACTIVE_POSITION_MONITOR_ENABLED", "false")
ACTIVE_POSITION_QUOTE_CRON = os.getenv("ACTIVE_POSITION_QUOTE_CRON", "* 9-16 * * 1-5")
ACTIVE_POSITION_EVALUATION_CRON = os.getenv(
    "ACTIVE_POSITION_EVALUATION_CRON", "*/5 9-16 * * 1-5"
)
ACTIVE_POSITION_MONITOR_TZ = os.getenv("ACTIVE_POSITION_MONITOR_TZ", "America/New_York")
ACTIVE_POSITION_NOTIFICATION_COOLDOWN_SECONDS = int(
    os.getenv("ACTIVE_POSITION_NOTIFICATION_COOLDOWN_SECONDS", "900")
)
ACTIVE_POSITION_MAX_SYMBOLS_PER_REFRESH = int(
    os.getenv("ACTIVE_POSITION_MAX_SYMBOLS_PER_REFRESH", "10")
)
ACTIVE_POSITION_DAILY_REQUEST_BUDGET = int(
    os.getenv("ACTIVE_POSITION_DAILY_REQUEST_BUDGET", "1000")
)
