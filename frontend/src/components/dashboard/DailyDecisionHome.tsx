// Home — daily portfolio decision dashboard (Robinhood holdings first).
"use client";
...
function ItemDetails({ item }: { item: PortfolioDecisionItem }) {
  return (
    <div className="space-y-1 rounded border border-zinc-800 bg-zinc-950/60 p-2 text-xs text-zinc-400">
        ...
        <>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <div className="surface-card p-3">
              ...
              <p className="text-2xl font-semibold tabular-nums text-[#7dff8e]">
            ...
            <div className="surface-card p-3">
              ...
              <p className="text-2xl font-semibold tabular-nums">${data.cash.toLocaleString()}</p>
            </div>
            <div className="surface-card p-3">
            ...
            <div className="surface-card p-3">
              <p className="text-[10px] uppercase text-zinc-500">{t.home.dailyLastRun}</p>
              <p className="text-sm font-medium text-zinc-200">
                {data.last_decision_run_at
                  ? formatDateTime(data.last_decision_run_at)
                  : t.home.dailyNeverRun}
              </p>
              <p className="mt-1 text-xs text-zinc-500">{t.home.dailyScheduleHint}</p>
            </div>
          </div>
